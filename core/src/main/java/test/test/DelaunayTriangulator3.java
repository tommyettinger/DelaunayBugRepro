 ...
 * <a href="http://paulbourke.net/papers/triangulate/">Paul Bourke's triangulate</a>.
 * @author Nathan Sweet
 * @author blue_crayfish */
public class DelaunayTriangulator3 {
	...
	public ShortArray computeTriangles (float[] points, int offset, int count, boolean sorted) {
		...
		double xmid = (xmax + xmin) / 2.0, ymid = (ymax + ymin) / 2.0;
